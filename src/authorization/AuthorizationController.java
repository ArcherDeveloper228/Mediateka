...
public class AuthorizationController {
	...
	// логический блок дл€ создани€ объекта клиента
	{
    ...
    private void initialize() {
    	...
    	// устанавливаем обработчик событи€ дл€ гиперссылки  registrationHyperlink
    	...
    	// устанавливаем обработчик событи€ дл€ кнопки button_signIn
    	this.button_signIn.setOnAction(event -> {

    		User user = null;

    		// выполн€ем поиск пользовател€ по логину
    		...
    		// провер€ем на правильное заполнение полей
    	...
    	// устанавливаем обработчик событи€ дл€ ComboBox show_password
